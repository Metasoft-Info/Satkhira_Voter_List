                    ...
                    <div class="border-t-2 border-gray-100 pt-4 sm:pt-6 mt-4 sm:mt-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <select x-model="upazila" @change="loadUnions()" 
                                    ...
                                    @foreach($upazilas as $upazila)
                                        <option value="{{ $upazila->id }}" x-text="lang === 'bn' ? '{{ $upazila->name_bn }}' : '{{ $upazila->name_en }}'"></option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select x-model="union" @change="loadAreaCodes()" 
                                    ...
                                    <template x-for="u in unions" :key="u.id">
                                        <option :value="u.id" :x-text="lang === 'bn' ? u.name_bn : u.name_en"></option>
                                    </template>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select x-model="ward" 
                                    ...
                                    @foreach($wards as $ward)
                                        <option value="{{ $ward->id }}" x-text="lang === 'bn' ? '{{ $ward->name_bn }}' : '{{ $ward->name_en }}'"></option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select x-model="areaCode" 
                                    ...
                                    <template x-for="ac in areaCodes" :key="ac.id">
                                        <option :value="ac.id" :x-text="ac.area_code_no + ' - ' + (lang === 'bn' ? ac.vote_center_name_bn : ac.vote_center_name_en)"></option>
                                    </template>
                                </select>
                            </div>
                        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <template x-for="voter in results" :key="voter.id">
                            <tr class="hover:bg-purple-50 transition">
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="voter.serial_no"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900" x-text="lang === 'bn' ? voter.name_bn : voter.name_en"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="voter.voter_id"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="lang === 'bn' ? voter.father_name_bn : voter.father_name_en"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="lang === 'bn' ? voter.mother_name_bn : voter.mother_name_en"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="lang === 'bn' ? voter.occupation_bn : voter.occupation_en"></td>
                                <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="voter.date_of_birth"></td>
                            </tr>
                        </template>
                    </tbody>
                </table>
