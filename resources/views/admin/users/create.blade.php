...
<head>
    ...
    <title>নতুন ইউজার - সাতক্ষীরা-২ ভোটার তালিকা</title>
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                <label class="block text-gray-700 font-medium mb-2">
                                    <i class="fas fa-lock mr-2 text-purple-600"></i>পাসওয়ার্ড <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-medium mb-2">
                                    <i class="fas fa-lock mr-2 text-purple-600"></i>পাসওয়ার্ড নিশ্চিত করুন <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                ...
                                <select name="role" required
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-purple-500 focus:outline-none">
                                    <option value="user" {{ old('role') == 'user' ? 'selected' : '' }}>ইউজার</option>
                                    <option value="moderator" {{ old('role') == 'moderator' ? 'selected' : '' }}>মডারেটর</option>
